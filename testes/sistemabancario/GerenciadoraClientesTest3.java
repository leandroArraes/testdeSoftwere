...
//		GerenciadoraClientes gerClientes = new GerenciadoraClientes(clientesDoBanco);
	...
	public void testeClienteIdadePermitida1() throws IdadeNaoPermitidaException{
		//Montagem de cenário
		Cliente cliente01 = new Cliente(3, "daniel ferrulha", 30, "daniel@gmail.com", 3, true);

		//Execução
	    boolean resultado = gerClientes.validaIdade(cliente01.getIdade());
...
public void testeClienteIdadePermitida2() throws IdadeNaoPermitidaException{
	//Montagem de cenário
	Cliente cliente01 = new Cliente(3, "perdro ferrulha", 18, "daniel@gmail.com", 4, true);
...
public void testeClienteIdadePermitida3() throws IdadeNaoPermitidaException{
	//Montagem de cenário
	Cliente cliente01 = new Cliente(3, "vitor ferrulha", 65, "daniel@gmail.com", 5, true);
...
// validação quando o cliente  não está no intervalo de idade permitido
@Test
public void testeClienteIdadePermitida4() throws IdadeNaoPermitidaException{
	//Montagem de cenário
	Cliente cliente01 = new Cliente(3, "amora ferrulha", 66, "daniel@gmail.com", 5, true);
...
public void testeClienteIdadePermitida5() throws IdadeNaoPermitidaException{
	//Montagem de cenário
	Cliente cliente01 = new Cliente(3, "vitor ferrulha", 17, "daniel@gmail.com", 5, true);
